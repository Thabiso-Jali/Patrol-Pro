...
from ....services.checkpoint_verifications import confirm_checkpoint
...
def update_checkpoint(
    ...
    checkpoint = lock_tenant_record(
        db, models.Checkpoint, record_id=checkpoint_id,
        organisation_id=current_user.organisation_id, relationship='Checkpoint',
    )
    assert_expected_version(checkpoint, parse_expected_version(if_match))
